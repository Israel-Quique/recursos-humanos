    ...
    <div class="sheet">
      <div class="header">
        ...
        <div class="badge">
          ...
          <div class="badge-value"><?php echo e($monthLabel); ?></div>
        </div>
      </div>
      ...
      <table class="grid">
        <tr>
          <td class="card" width="50%">
            ...
            <div class="value"><?php echo e($detailEmployeeReport['empleado']['nombre'] ?? 'Sin nombre'); ?></div>
          </td>
          <td class="card" width="50%">
            <div class="label">Codigo</div>
            <div class="value"><?php echo e($detailEmployeeReport['empleado']['codigo'] ?? 'Sin codigo'); ?></div>
          </td>
        </tr>
        <tr>
          <td class="card" width="50%">
            <div class="label">Sucursal</div>
            <div class="value"><?php echo e($detailEmployeeReport['empleado']['sucursal'] ?? 'Sin sucursal'); ?></div>
          </td>
          <td class="card" width="50%">
            <div class="label">Horario</div>
            <div class="value"><?php echo e($detailEmployeeReport['empleado']['horario'] ?? '--:-- - --:--'); ?></div>
          </td>
        </tr>
      </table>
        ...
        <tr>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ($detailEmployeeReport['metrics'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <td class="card">
              ...
              <div class="value-sm"><?php echo e($metric['value']); ?></div>
            </td>
...
<?php /**PATH C:\Users\israe\OneDrive\Desktop\Pasantia\Proyectos\recursos-humanos\resources\views/pdf/reportes-detalle-empleado.blade.php ENDPATH**/ ?>