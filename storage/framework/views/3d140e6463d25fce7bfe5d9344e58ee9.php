        ...
        <div class="app-sidebar-panel">
          ...
          <nav class="app-sidebar-nav">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ver reportes')): ?>
              <div x-data="{ open: <?php echo e(request()->routeIs('reportes') || request()->routeIs('reportes.mensual-no-marcados-atrasos') ? 'true' : 'false'); ?> }">
                <button type="button" x-on:click="open = ! open" class="app-sidebar-link w-full text-left <?php echo e(request()->routeIs('reportes') || request()->routeIs('reportes.mensual-no-marcados-atrasos') ? 'app-sidebar-link-active' : ''); ?>" x-bind:aria-expanded="open.toString()">
                  <span class="app-sidebar-link-icon">
                ...
                <div x-cloak x-show="open" x-transition.opacity.duration.150ms class="app-sidebar-submenu">
                  <a wire:navigate href="<?php echo e(route('reportes')); ?>" class="app-sidebar-sublink <?php echo e(request()->routeIs('reportes') ? 'app-sidebar-sublink-active' : ''); ?>"><span class="app-sidebar-subdot"></span>Resumen general</a>
                  <a wire:navigate href="<?php echo e(route('reportes.mensual-no-marcados-atrasos')); ?>" class="app-sidebar-sublink <?php echo e(request()->routeIs('reportes.mensual-no-marcados-atrasos') ? 'app-sidebar-sublink-active' : ''); ?>"><span class="app-sidebar-subdot"></span>No marcados y atrasos</a>
                </div>
              </div>
            <?php endif; ?>
