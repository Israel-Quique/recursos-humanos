<div class="page-stack" x-data="{ tab: 'resumen' }">
  ...
  <div class="report-tab-nav" role="tablist">
    ...
    <button type="button" role="tab" :aria-selected="tab === 'atrasos'" @click="tab = 'atrasos'"
      ...
      <span>Atrasos</span>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($totalAtrasos ?? 0) > 0): ?>
        <span class="report-tab-badge report-tab-badge-amber"><?php echo e($totalAtrasos); ?></span>
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </button>
    <button type="button" role="tab" :aria-selected="tab === 'omisiones'" @click="tab = 'omisiones'"
      ...
      <span>Omisiones</span>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($totalOmisiones ?? 0) > 0): ?>
        <span class="report-tab-badge report-tab-badge-rose"><?php echo e($totalOmisiones); ?></span>
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </button>
    ...
    <section class="surface-card">
      <div class="history-header">
        ...
        <div class="flex items-center gap-3">
          <span class="status-badge status-warning"><?php echo e($totalAtrasos); ?> atrasos</span>
      ...
      <div class="history-table-shell mt-8">
        <table class="history-table">
          ...
          <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $detalleAtrasos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr class="report-atraso-row">
                <td class="text-center font-bold text-slate-400"><?php echo e(($detalleAtrasos->currentPage() - 1) * $detalleAtrasos->perPage() + $index + 1); ?></td>
                <td><span class="font-semibold text-slate-800"><?php echo e($item['nombre']); ?></span></td>
                <td><span class="font-mono text-xs text-slate-600 bg-slate-100 px-2 py-0.5 rounded"><?php echo e($item['codigo'] ?: '-'); ?></span></td>
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detalleAtrasos->hasPages()): ?>
        <div class="mt-6">
          <?php echo e($detalleAtrasos->links()); ?>
  ...
  <div x-show="tab === 'omisiones'" x-transition.opacity.duration.200ms role="tabpanel">
    <section class="surface-card">
      <div class="history-header">
        ...
        <div class="flex items-center gap-3">
          <span class="status-badge status-danger"><?php echo e($totalOmisiones); ?> omisiones</span>
          <button type="button" wire:click="descargarPdfReporte" class="section-action-button">PDF</button>
        </div>
      </div>
      <div class="history-table-shell mt-8">
        <table class="history-table">
          ...
          <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $detalleOmisiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr class="report-omision-row">
                <td class="text-center font-bold text-slate-400"><?php echo e(($detalleOmisiones->currentPage() - 1) * $detalleOmisiones->perPage() + $index + 1); ?></td>
                <td><span class="font-semibold text-slate-800"><?php echo e($item['nombre']); ?></span></td>
                <td><span class="font-mono text-xs text-slate-600 bg-slate-100 px-2 py-0.5 rounded"><?php echo e($item['codigo'] ?: '-'); ?></span></td>
                <td><?php echo e($item['sucursal']); ?></td>
                <td><?php echo e($item['fecha']); ?></td>
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detalleOmisiones->hasPages()): ?>
        <div class="mt-6">
          <?php echo e($detalleOmisiones->links()); ?>
