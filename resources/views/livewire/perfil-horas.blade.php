    ...
    <div style="background:#fff;border:1.5px solid {{ $excedio ? '#fecdd3' : '#cbd5e1' }};border-radius:1.25rem;padding:1.15rem 1.35rem;box-shadow:0 4px 18px rgba(15,23,42,.04);position:relative;overflow:hidden;">
      ...
      <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;flex-wrap:wrap;">
        <div style="flex:1;min-width:260px;">
          ...
          <p style="font-size:.84rem;font-weight:600;color:#334155;margin:0 0 .4rem 0;line-height:1.45;">
            ⏱️ <strong>Plazo de 48 horas:</strong> Toda omisión de marcado o atraso debe justificarse dentro de las <strong>48 horas</strong> mediante boleta oficial.
          </p>

          <p style="font-size:.84rem;font-weight:600;color:#334155;margin:0;line-height:1.45;">
            ⚖️ <strong>Garantía reglamentaria:</strong> Las sanciones se aplican estrictamente según las causales del <strong>Reglamento Interno (Art. 45)</strong>.
          </p>
        </div>
